...
fitted %>%
  ...
  geom_density(aes(x = treatmentControl), fill = "red")

# when there is treatment imposed in our experiment, there is an increase
# in the probability of a change in attitude.
...
fitted %>% 
  ...
  ggplot(aes(x = ate)) +
    geom_histogram(aes(y = after_stat(count/sum(count))),
                   bins = 100) +
  labs(title = "Average Treatment Effect Posterior Distribution",
       x = "Average Treatment Effect",
       y = "Probability")

# ATE represents the average change in attitude for the treatment group minus 
# the average change in attitude for the control group. This posterior distribution
# represents the probability of receiving different average treatment effects 
# 
```
